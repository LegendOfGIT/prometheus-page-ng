      ...
      this.itemsService.getRandomItemOfCategories(this.subNavigationItems.map(navigationItem => navigationItem.toId))
        ...
        .subscribe(
          itemsResponse => {
            ...
            script.innerHTML = 'setTimeout(function() { $(".carousel__viewport").slick({ arrows: false, dots: false, infinite: true, slidesToScroll: 3, slidesToShow: 3, responsive: [{ breakpoint: 576, settings: { slidesToScroll: 2, slidesToShow: 2 } }, { breakpoint: 1280, settings: { slidesToScroll: 4, slidesToShow: 4 } }] }); });';
