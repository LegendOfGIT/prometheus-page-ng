...
export class Navigation {
  ...
  public static ITEMS: NavigationItem[] = [
    ...
    new NavigationItem('FASHION_WOMEN', 'FASHION_WOMEN_NIGHTWEAR', ['fashion', 'women', 'night-wear']),
    ...
    new NavigationItem('FASHION_MEN', 'FASHION_MEN_NIGHTWEAR', ['fashion', 'men', 'night-wear']),
