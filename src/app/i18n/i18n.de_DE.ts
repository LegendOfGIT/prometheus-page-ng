...
export class I18nDeDe implements I18nInterface {
  public getTranslations(): any {
    return {
      ...
      DISCOUNT_CONDITIONS_SILKESWK_NEUJAHR: 'Ab 149 EUR Mindestbestellwert.',
      ...
      DISCOUNT_TEASER_SILKESWK_NEUJAHR: 'Du erhälst einen 20 EUR Gutschein',
      DISCOUNT_TEASER_SRLOPEZ_XMAS: '10% Rabatt auf die gesamte Bestellung',
      DISCOUNT_TEASER_VANDERSTORM_ENDSPURT: 'Bis zu 75% Rabatt + 10% Extra-Rabatt',
