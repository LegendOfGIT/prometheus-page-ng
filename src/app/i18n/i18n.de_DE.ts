...
export class I18nDeDe implements I18nInterface {
  public getTranslations(): any {
    return {
      ...
      PRODUCT_DETAILS_ANNUAL_CONSUMPTION_IN_KWH: 'Jährlicher Energieverbrauch',
      ...
      PRODUCT_DETAILS_INNER_MATERIAL: 'Innenmaterial',
      PRODUCT_DETAILS_OUTER_MATERIAL: 'Außenmaterial',
      ...
      PRODUCT_DETAILS_WEIGHT_IN_KG: 'Gewicht',
