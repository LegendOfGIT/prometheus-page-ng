...
export class I18nDeDe implements I18nInterface {
  public getTranslations(): any {
    return {
      ...
      DISCOUNT_CONDITIONS_MESSMER_COLDTEA: 'Die Teilnahme an der Aktion ist kostenlos, jedoch an den Kauf von drei Aktionsprodukten während des Aktionszeitraums (01.01.2024 bis 31.03.2024) gebunden. Wenn im Warenkorb mindestens drei Packungen Meßmer COLD TEA vorhanden sind, wird dem Warenkorb automatisch die Gratisbeigabe hinzugefügt. Aktionsprodukte sind alle Meßmer COLD TEA Packungen.',
      ...
      DISCOUNT_TEASER_MESSMER_COLDTEA: 'Cold Tea: 3 Packungen kaufen = 1 Sportflasche GRATIS',
      ...
      FILTERS_COO_AFRICA: 'Afrika',
      FILTERS_COO_ARGENTINA: 'Argentinien',
      FILTERS_COO_AUSTRALIA: 'Australien',
      FILTERS_COO_BRAZIL: 'Brasilien',
      FILTERS_COO_CHINA: 'China',
      FILTERS_COO_DENMARK: 'Dänemark',
      FILTERS_COO_GERMANY: 'Deutschland',
      FILTERS_COO_FRANCE: 'Frankreich',
      FILTERS_COO_GREECE: 'Griechenland',
      FILTERS_COO_INDIA: 'Indien',
      FILTERS_COO_IRELAND: 'Irland',
      FILTERS_COO_ISRAEL: 'Israel',
      FILTERS_COO_ITALY: 'Italien',
      FILTERS_COO_JAPAN: 'Japan',
      FILTERS_COO_CANADA: 'Kanada',
      FILTERS_COO_KOREA: 'Korea',
      FILTERS_COO_MEXICO: 'Mexiko',
      FILTERS_COO_NETHERLANDS: 'Niederlande',
      FILTERS_COO_AUSTRIA: 'Österreich',
      FILTERS_COO_PORTUGAL: 'Portugal',
      FILTERS_COO_SCOTLAND: 'Schottland',
      FILTERS_COO_SWEDEN: 'Schweden',
      FILTERS_COO_SPAIN: 'Spanien',
      FILTERS_COO_HUNGARY: 'Ungarn',
      FILTERS_COO_USA: 'USA',
      FILTERS_COO_VENEZUELA: 'Venezuela',
      FILTERS_COO_UNITEDKINGDOM: 'Großbritanien',
      FILTERS_COOS: 'Herkunftsländer',
      FILTERS_DONE: 'fertig',
      ...
      FILTERS_PRODUCTTYPES_COFFEE: 'Kaffee',
      FILTERS_PRODUCTTYPES_COFFEEACCESSORIES: 'Kaffee Zubehör',
      ...
      FILTERS_PRODUCTTYPES_EROTICUNDERWEAR: 'Erotik-Unterwäsche',
      ...
      FILTERS_TASTETYPES: 'Geschmacksrichtungen',
      FILTERS_TASTETYPES_FLOWERY: 'blumig',
      FILTERS_TASTETYPES_FRESH: 'frisch',
      FILTERS_TASTETYPES_FRUITY: 'fruchtig',
      FILTERS_TASTETYPES_STRONG: 'kräftig',
      ...
      MESSAGE_WISHLIST_CAN_NOT_CREATE_WISHLIST: 'Wunschliste konnte nicht erstellt werden. (Bitte prüfe ob du verbotene Begriffe im Titel oder der Beschreibung hast)',
      MESSAGE_WISHLIST_CAN_NOT_UPDATE_WISHLIST: 'Wunschliste konnte nicht aktualisiert werden. (Bitte prüfe ob du verbotene Begriffe im Titel oder der Beschreibung hast)',
      ...
      MESSAGE_WISHLIST_UPDATED_WISHLIST: 'Wunschliste "{wishlistName}" wurde aktualisiert.',
      ...
      NAVIGATION_ELECTRONICS_AND_COMPUTERS_HOME_HEADPHONES: 'Kopfhörer',
      ...
      NAVIGATION_ELECTRONICS_AND_COMPUTERS_HOME_SPEAKERS: 'Lautsprecher',
      ...
      NAVIGATION_ELECTRONICS_AND_COMPUTERS_PHONES_SMARTPHONEACCESSORIES: 'Smartphone Zubehör',
      ...
      NAVIGATION_DIY_BUILDANDRENOVATE_BATHROOM: 'Badezimmer',
      ...
      NAVIGATION_DIY_BUILDANDRENOVATE_RADIATORS: 'Heizungen',
      ...
      NAVIGATION_DIY_HOUSEINSTALLATIONS: 'Hausinstallation',
      NAVIGATION_DIY_HOUSEINSTALLATIONS_INTERCOMS: 'Gegensprechanlagen',
      NAVIGATION_DIY_HOUSEINSTALLATIONS_MAILBOXES: 'Briefkästen',
      ...
      NAVIGATION_FASHION_BOYS_HATS: 'Jungen Kopfbedeckungen',
      ...
      NAVIGATION_FASHION_MEN_HATS: 'Herren Kopfbedeckungen',
      ...
      NAVIGATION_HOME_GARDEN_PLANTS: 'Pflanzen',
      ...
      NAVIGATION_MULTIMEDIA_BOOKS_COMICS: "Comic Bücher",
      ...
      NAVIGATION_MULTIMEDIA_BOOKS_NUTRITION: "Ernährungs Bücher",
      ...
      PRODUCT_DETAILS_PROTECTIONCLASS: 'Sicherheitsklasse',
      PRODUCT_DETAILS_NIGHTVISIONMODE: 'Nachtsichtmodus',
      ...
      PRODUCT_DETAILS_CONSUMPTIONINW: 'Energieverbrauch',
      ...
      SEO_DESCRIPTION_APPLEIPHONES: 'Erlebe die Leistung, das atemberaubende Design und eine Welt voller Möglichkeiten, die dir zur Verfügung steht. Rüste auf das Nonplusultra in Sachen Technologie und Stil auf. Entdecke noch heute die Freude, ein iPhone zu besitzen.',
      SEO_DESCRIPTION_BESTEINHELLACCUTOOLS: 'Erlebe erstklassige Leistung und Komfort bei jeder Aufgabe. Entdecke unsere Sammlung an leistungsstarken und effizienten Akku-Werkzeugen von Einhell, die deine Arbeit neu definieren!',
      SEO_DESCRIPTION_BESTBOSCHACCUDRILLINGMACHINE: 'Realisiere deine Projekte mit den ultimativen Akku-Geräten von Bosch. Entfessele bei jeder Aufgabe überlegene Leistung und unübertroffene Präzision. Entdecke unsere Auswahl an Elektrowerkzeugen der Spitzenklasse, die deine Arbeit auf ein neues Niveau heben werden.',
      SEO_DESCRIPTION_BLACKWOMENJEANS: 'Entdecke bequeme und stilvolle schwarze Jeans – von klassischen bis zu trendigen Passformen. Perfekt für einen lässigen Look oder einen Hauch von Klasse. Find jetzt dein neues Lieblingspaar.',
      SEO_DESCRIPTION_GIFTSFORCOFFELOVERS: 'Entdecke die perfekten Geschenke für Kaffeeliebhaber in unserer Kollektion. Von erstklassigen Bohnen bis hin zu stilvollem Kaffee Zubehör – bringe jetzt Freude in jede Tasse!',
      ...
      SEO_DESCRIPTION_TOYSFORCOUPLES: 'Entdeckt euere Initimität neu mit unserer faszinierenden Auswahl an Paarvibratoren. Von diskreten Optionen bis hin zu innovativen Designs ist unser Sortiment darauf ausgelegt, Verbundenheit und Leidenschaft zu intensivieren. Peppen Sie Ihre gemeinsamen Momente mit diesen auf Vergnügen ausgerichteten Begleitern auf und definieren Sie Zufriedenheit für beide Partner neu. Entfachen Sie Leidenschaft und schaffen Sie unvergessliche Erlebnisse mit unserer vielfältigen Auswahl an Paarvibratoren.',
      SEO_DESCRIPTION_TOYSFORHER: 'Gönne dir allergrößtes Vergnügen mit unserem verlockenden Sortiment an Vibratoren. Von diskreten Optionen bis hin zu innovativen Designs ist unsere Auswahl darauf ausgelegt, deine Zufriedenheit zu steigern und deine intimen Momente neu zu definieren. Entdecke eine Vielzahl  Begleiter für dein Schlafzimmer, die auf deine Wünsche zugeschnitten sind. Entfache die Leidenschaft und schaffe unvergessliche Erlebnisse.',
      ...
      SEO_PAGE_TITLE_BESTBOSCHACCUDRILLINGMACHINE: 'Der beste Bosch Akkuschrauber',
      SEO_PAGE_TITLE_BESTEINHELLACCUTOOLS: 'Die besten Einhell Akku Geräte',
      ...
      SEO_PAGE_TITLE_GIFTSFORCOFFELOVERS: 'Geschenke für Kaffeeliebhaber',
      SEO_PAGE_TITLE_PLAYSTATION5SHOOTER: 'Playstation 5 Shooter online kaufen',
      SEO_PAGE_TITLE_TOYSFORCOUPLES: 'Toys für Paare online kaufen',
      SEO_PAGE_TITLE_TOYSFORHER: 'Toys für Frauen online kaufen',
      SEO_PAGE_TITLE_WHITEWOMENJEANS: 'Weiße Damenjeans online kaufen',
      SEO_CATEGORY_PAGE_TITLE: 'Aus {category} online kaufen',
      SEO_SINGLE_PRODUCT_VIEW_PAGE_TITLE: '{product-name} online kaufen',
      SEO_STARTPAGE_TEASER: 'In der schnelllebigen Welt des Online-Shoppings ist deine Privatsphäre wichtig, wird aber oft nicht genug respektiert. Tauche mit uns ein in die Leichtigkeit des anonymen Einkaufens, das für jeden von euch entwickelt wurde. Stell dir vor, du entdeckst und kaufst deine Lieblingsprodukte ohne ständige Werbung oder Datenverfolgung. Freue dich darüber zu deinen Bedingungen online zu kaufen, frei von unerwünschter Analyse deiner persönlichen Daten. Übernehme die Kontrolle, finde deine Lieblingsprodukte anonym bei uns und genieße Komfort ohne Kompromisse. Es ist Zeit, dass Online-Shopping für dich funktioniert, ohne das du etwas auf dem Weg dahin Preis gibst! Ein erster Schritt in ein sorglose Verwendung des Internets.',
      SEO_UNKNOWN_CATEGORY_PAGE_TITLE: 'Deine Lieblingsprodukte online kaufen',
      SHARE: 'Teilen',
      ...
      TEASER_TITLE_FAMILY_TRIP: 'Für den nächsten Familienausflug',
      ...
      WISHLIST_ACTION_CANCEL_MANAGE_WISHLIST: 'abbrechen',
