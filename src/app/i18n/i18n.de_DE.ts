...
export class I18nDeDe implements I18nInterface {
  public getTranslations(): any {
    return {
      ...
      SEO_PAGE_TITLE_APPLEIPHONES: 'Kaufe iPhones auf WeWanna.shop',
      SEO_PAGE_TITLE_BLACKWOMENJEANS: 'Kaufe schwarze Damen Jeans auf WeWanna.shop',
      SEO_PAGE_TITLE_PLAYSTATION5SHOOTER: 'Kaufe Playstation 5 Shooter auf WeWanna.shop',
      SEO_PAGE_TITLE_SENORLOPEZ: 'Entdecke Senor Lopez auf WeWanna.shop',
      SEO_PAGE_TITLE_WHITEWOMENJEANS: 'Kaufe weiße Damen Jeans auf WeWanna.shop',
      SEO_CATEGORY_PAGE_TITLE: 'Kaufe aus {category} online auf WeWanna.shop',
      SEO_SINGLE_PRODUCT_VIEW_PAGE_TITLE: '{product-name} | Kaufe online auf WeWanna.shop',
      ...
      SEO_UNKNOWN_CATEGORY_PAGE_TITLE: 'Kaufe online auf WeWanna.shop',
      SHARE: 'Teilen',
