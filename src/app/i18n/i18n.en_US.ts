...
export class I18nEnUs implements I18nInterface {
  public getTranslations(): any {
    return {
      ...
      DISCOUNT_CONDITIONS_SRLOPEZ_XMAS: 'From 15 EUR minimum order value. One use per customer. Cannot be combined with other discounts.',
      ...
      DISCOUNT_TEASER_SRLOPEZ_XMAS: '10% discount on the entire order',
      ...
      SEO_PAGE_TITLE_SENORLOPEZ: 'Discover Senor Lopez spices',
