...
export class I18nEnUs implements I18nInterface {
  public getTranslations(): any {
    return {
      ...
      DISCOUNT_CONDITIONS_SILKESWK_NEUJAHR: 'From 149 EUR minimum order value.',
      ...
      DISCOUNT_TEASER_SILKESWK_NEUJAHR: 'You get a 20 EUR voucher',
      DISCOUNT_TEASER_SRLOPEZ_XMAS: '10% discount on the entire order',
      DISCOUNT_TEASER_VANDERSTORM_ENDSPURT: 'Up to 75% Disccunt + 10% Extra-Discount',
