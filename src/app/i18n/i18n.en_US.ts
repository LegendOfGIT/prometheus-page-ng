...
export class I18nEnUs implements I18nInterface {
  public getTranslations(): any {
    return {
      ...
      MESSAGE_WISHLIST_CAN_NOT_CREATE_WISHLIST: 'Wishlist can not be created. (check forbidden terms in title or description)',
      MESSAGE_WISHLIST_CAN_NOT_UPDATE_WISHLIST: 'Wishlist can not be updated. (check forbidden terms in title or description)',
      ...
      MESSAGE_WISHLIST_UPDATED_WISHLIST: 'Wishlist "{wishlistName}" was updated.',
      ...
      TEASER_HALLOWEEN_COSTUMES: 'Halloween costumes',
      ...
      TEASER_TITLE_MOTHERS_DAY: 'Presents for Mothers Day',
      ...
      WISHLIST_ACTION_CANCEL_MANAGE_WISHLIST: 'cancel',
