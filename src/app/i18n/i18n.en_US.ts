...
export class I18nEnUs implements I18nInterface {
  public getTranslations(): any {
    return {
      ...
      DISCOUNT_CONDITIONS_NATURESWAY_4THADVENT: 'Redeemable in the shopping cart. Cannot be combined with other vouchers.',
      ...
      DISCOUNT_TEASER_NATURESWAY_4THADVENT: 'No shipping costs',
